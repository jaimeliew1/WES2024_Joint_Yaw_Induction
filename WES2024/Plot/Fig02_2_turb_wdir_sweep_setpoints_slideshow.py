...
def plot(df: pl.DataFrame, methods: list[str], suffix:str):
    ...
    axes[0, 0].legend(handles=_lines, loc="lower center", ncol=4, bbox_to_anchor=(1.1, 1.01))
...
def main():
    ...
    plot(df, ["NoControl", "ThrustControl"], "_1")
    plot(df, ["NoControl", "ThrustControl", "YawControl"], "_2")
    plot(df, ["NoControl", "ThrustControl", "YawControl", "JointControl"], "_3")
