...
@cache_polars(Path(__file__).parent.parent / "data/plot_04_square.csv")
...
def plot_Cp_vs_distance(df: pl.DataFrame):
    ...
    plt.savefig(FIGDIR / "square_Cp_vs_distance.png", dpi=300, bbox_inches="tight")
...
def plot_farm_performance_vs_distance(df: pl.DataFrame):
    ...
    plt.savefig(FIGDIR / "square_farm_performance_vs_distance.png", dpi=300, bbox_inches="tight")
...
def plot_windfarm(df: pl.DataFrame):
    for min_dist in df["min_dist"].unique():
        ...
        plt.savefig(FIGDIR / f"square_windfarm_{min_dist}D.png", dpi=300, bbox_inches="tight")
        plt.close()
...
def plot_setpoints(df: pl.DataFrame):
    ...
    axes[0].set_xlim(0, 360)
    plt.savefig(FIGDIR / "square_setpoints.png", dpi=300, bbox_inches="tight")
